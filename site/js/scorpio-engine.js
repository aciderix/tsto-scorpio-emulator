...
class ScorpioEngine {
    ...
    async runInit(width, height) {
        ...
        // === v37: Post-init auth bootstrapping (SKIPPED — causes >10K ARM instruction timeout) ===
        // NimbleCppComponent_setup loops >10K ARM instructions without completing.
        // onNimblePushTNGReady has no effect without prior Nimble setup.
        // Auth will need to be injected via nativeCallback or memory patching post-init.
        Logger.info('v37: SKIPPING NimbleCppComponent_setup & onNimblePushTNGReady (timeout prevention)');
        Logger.info('v37: Auth token injection will be attempted post-init');
